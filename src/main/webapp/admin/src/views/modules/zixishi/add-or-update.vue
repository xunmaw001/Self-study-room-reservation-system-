<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="自习室编号" prop="zixishibianhao">
            <el-input v-model="ruleForm.zixishibianhao" 
                placeholder="自习室编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.zixishibianhao" label="自习室编号" prop="zixishibianhao">
              <el-input v-model="ruleForm.zixishibianhao" 
                placeholder="自习室编号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="可约时段" prop="keyueshiduan">
          <el-input v-model="ruleForm.keyueshiduan" 
              placeholder="可约时段" clearable  :readonly="ro.keyueshiduan"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="可约时段" prop="keyueshiduan">
              <el-input v-model="ruleForm.keyueshiduan" 
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='zixishibianhao'){
            this.ruleForm.zixishibianhao = obj[o];
	    this.ro.zixishibianhao = true;
            continue;
          }
	...
	this.ruleForm.xiangqing = this.ruleForm.xiangqing.replace(reg,'../../../ssmdls35/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
