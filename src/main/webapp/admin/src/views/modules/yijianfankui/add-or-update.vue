      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="反馈名称" prop="fankuimingcheng">
          <el-input v-model="ruleForm.fankuimingcheng" 
              placeholder="反馈名称" clearable  :readonly="ro.fankuimingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="反馈名称" prop="fankuimingcheng">
              <el-input v-model="ruleForm.fankuimingcheng" 
...
export default {
  ...
  methods: {
	...
	this.ruleForm.fankuineirong = this.ruleForm.fankuineirong.replace(reg,'../../../ssmdls35/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
