...
public class ZixishiEntity<T> implements Serializable {
	 ...
	 * 设置：自习室编号
	 */
	public void setZixishibianhao(String zixishibianhao) {
		this.zixishibianhao = zixishibianhao;
	}
	/**
	 * 获取：自习室编号
	 */
	public String getZixishibianhao() {
		return zixishibianhao;
	}
	/**
	 * 设置：自习室名称
	 */
